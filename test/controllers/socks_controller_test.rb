...
class SocksControllerTest < ActionController::TestCase
  ...
  test "should create sock" do
    assert_difference('Sock.count') do
      post :create, sock: { color: @sock.color, foot: @sock.foot, quantity: @sock.quantity, size: @sock.size }
    end
  ...
  test "should update sock" do
    patch :update, id: @sock, sock: { color: @sock.color, foot: @sock.foot, quantity: @sock.quantity, size: @sock.size }
    assert_redirected_to sock_path(assigns(:sock))
  end
